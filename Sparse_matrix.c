...
int main() {
    ...
    sp_transpose[0][0] = cols;   
    sp_transpose[0][1] = rows;   
    ...
    if (terms > 0) {
        ...
        for (int col_index = 0; col_index < cols; col_index++) {
            for (i = 1; i <= terms; i++) {
                if (sp_sum[i][1] == col_index) {
                    sp_transpose[pos][0] = sp_sum[i][1];  
                    sp_transpose[pos][1] = sp_sum[i][0];
                    sp_transpose[pos][2] = sp_sum[i][2];
                    pos++;
                }
            }
        }
